...
app.get("/api/restaurant-plans", async (req, res) => {
	...
	if ((user.dietaryPreferences === "vegetarian"  || user.dietaryPreferences === "non_vegetarian" || user.dietaryPreferences === "sugarfree" || user.dietaryPreferences === "vegan" )&& user.age > 30) {
